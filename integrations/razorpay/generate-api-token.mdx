...
## Step 2: Access API Keys & Integration

Once you are inside **Account & Settings**, scroll down to locate the **API Keys & Integration** section. This section contains the API credentials required to integrate Razorpay with RabbitPay.
...
<Frame caption="Figure 2: API Keys & Integration section showing the Regenerate Key option.">
...
## Step 3: Generate or Retrieve API Keys
